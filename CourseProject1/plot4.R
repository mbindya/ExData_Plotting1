...
par(mfrow=c(2,2))
plot(powerConsumption$dateTime, as.numeric(powerConsumption$Global_active_power), type="l", xlab="", ylab="Global Active Power")

plot(powerConsumption$dateTime, as.numeric(powerConsumption$Voltage), type="l", xlab="datetime", ylab="Voltage")
...
plot(powerConsumption$dateTime, as.numeric(powerConsumption$Global_reactive_power), type="l", xlab="powerConsumption$dateTime", ylab="Global_reactive_power")
dev.off()
